...
* <b> Categorization </b>
    > Categorization model is a model that determines which category would be appropriate for the contents.
    * File
        * <b> dataset </b> : Datasets we used to create and test the Categorization Model
          *  README.md : Links to download the dataset
        * <b> model </b> : Python files to train the model and perform the inference
          * train.py : Python file for training
          * infer.py : Python file for inference
        * README.md : Markdown file that writes out what we need to run Categorization model
    * Implemented Model : [KoBERT](https://github.com/SKTBrain/KoBERT)
